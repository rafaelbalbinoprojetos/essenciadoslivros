...
const THEME_PRESETS = [
  ...
  createThemePreset({
    id: "essencia-literaria-light",
    name: "Essência Literária — Claro",
    description:
      "Clássico e sereno — tons lavanda e dourado suave inspirados em páginas de livros e luz natural, mantendo o toque artístico do universo Essência dos Livros.",
    mode: "light",
    preview: ["#8B5CF6", "#FBBF24", "#F9FAFB", "#E5E7EB", "#1F2937"],
    colors: {
      accent: "#8B5CF6",
      accentLight: "#A78BFA",
      accentDark: "#6D28D9",
      secondary: "#FBBF24",
      tertiary: "#3B82F6",
      surfaceBase: "249 250 251",
      surfaceCard: "255 255 255",
      surfaceMuted: "229 231 235",
      borderSoft: "rgba(139,92,246,0.14)",
      borderStrong: "rgba(251,191,36,0.22)",
      textPrimary: "31 41 55",
      textSecondary: "75 85 99",
      textSubtle: "107 114 128",
      surfaceGradient:
        "radial-gradient(circle at 20% 10%, rgba(139,92,246,0.15), transparent 60%), radial-gradient(circle at 80% 0%, rgba(251,191,36,0.12), transparent 58%), linear-gradient(160deg, rgba(249,250,251,0.95), rgba(255,255,255,0.98))",
      shadowSm: "0 16px 34px -26px rgba(139,92,246,0.15)",
      shadowMd: "0 52px 100px -60px rgba(251,191,36,0.18)",
      shadowLg: "0 120px 210px -95px rgba(139,92,246,0.25)",
      ringGlow: "0 0 0 3px rgba(139,92,246,0.25)",
    },
  }),
  createThemePreset({
    id: "pergaminho-dourado",
    name: "Pergaminho Dourado",
    description:
      "Elegante e atemporal — tons de pergaminho, areia e dourado envelhecido com acentos roxos sutis. Evoca o charme das antigas bibliotecas e manuscritos iluminados.",
    mode: "light",
    preview: ["#C8B79A", "#D7C9A6", "#F4EBD0", "#8B5CF6", "#5C4033"],
    colors: {
      accent: "#8B5CF6",
      accentLight: "#A78BFA",
      accentDark: "#6D28D9",
      secondary: "#D4AF37",
      tertiary: "#C8B79A",
      surfaceBase: "244 235 208",
      surfaceCard: "247 240 219",
      surfaceMuted: "215 201 166",
      borderSoft: "rgba(139,92,246,0.12)",
      borderStrong: "rgba(212,175,55,0.28)",
      textPrimary: "49 46 38",
      textSecondary: "84 74 60",
      textSubtle: "119 106 88",
      surfaceGradient:
        "radial-gradient(circle at 25% 10%, rgba(212,175,55,0.18), transparent 60%), radial-gradient(circle at 80% 0%, rgba(139,92,246,0.10), transparent 58%), linear-gradient(160deg, rgba(244,235,208,0.95), rgba(247,240,219,0.98))",
      shadowSm: "0 16px 34px -26px rgba(92,64,51,0.20)",
      shadowMd: "0 52px 100px -60px rgba(212,175,55,0.20)",
      shadowLg: "0 120px 210px -95px rgba(139,92,246,0.25)",
      ringGlow: "0 0 0 3px rgba(212,175,55,0.22)",
    },
  }),
  createThemePreset({
    id: "biblioteca-noturna",
    name: "Biblioteca Noturna",
    description:
      "Luxuosa e introspectiva — tons de pergaminho escuro, ouro envelhecido e violeta profundo. Inspirada em bibliotecas antigas iluminadas por lamparinas.",
    mode: "dark",
    preview: ["#1C1917", "#3B2F2A", "#D4AF37", "#8B5CF6", "#BFAF90"],
    colors: {
      accent: "#8B5CF6",
      accentLight: "#A78BFA",
      accentDark: "#5B21B6",
      secondary: "#D4AF37",
      tertiary: "#BFAF90",
      surfaceBase: "28 25 23",
      surfaceCard: "43 37 33",
      surfaceMuted: "59 47 42",
      borderSoft: "rgba(212,175,55,0.20)",
      borderStrong: "rgba(139,92,246,0.25)",
      textPrimary: "239 235 229",
      textSecondary: "214 204 184",
      textSubtle: "168 156 132",
      surfaceGradient:
        "radial-gradient(circle at 30% 15%, rgba(212,175,55,0.15), transparent 60%), radial-gradient(circle at 80% 0%, rgba(139,92,246,0.15), transparent 58%), linear-gradient(160deg, rgba(28,25,23,0.95), rgba(43,37,33,0.98))",
      shadowSm: "0 16px 34px -26px rgba(212,175,55,0.20)",
      shadowMd: "0 52px 100px -60px rgba(139,92,246,0.20)",
      shadowLg: "0 120px 210px -95px rgba(212,175,55,0.25)",
      ringGlow: "0 0 0 3px rgba(212,175,55,0.28)",
    },
  }),
];
